...
class CampaignAdmin(admin.ModelAdmin):
    list_display = ("name", "template_name", "language_code", "status", "dry_run", "created_by", "created_at")
...
class RecipientAdmin(admin.ModelAdmin):
    list_display = ("row_number", "phone", "name", "status", "whatsapp_message_id", "campaign", "updated_at")
...
class MessageLogAdmin(admin.ModelAdmin):
    list_display = ("direction", "event_type", "status", "campaign", "recipient", "created_at")
